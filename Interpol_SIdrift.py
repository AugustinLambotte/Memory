    ...
    for year in range(year_,year_end):
        ...
        for month in range(1,13):
            ...
            for day in range(1,nb_days+1):
                ...
                np.savetxt(f'Data/X_drift/{year}/{month_name}/{day}.txt',X_drift[f'y{year}'][month_name][-1])
                np.savetxt(f'Data/Y_drift/{year}/{month_name}/{day}.txt',Y_drift[f'y{year}'][month_name][-1])
